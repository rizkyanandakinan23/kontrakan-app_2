...
<div class="mb-6">
    ...
    <div class="grid md:grid-cols-3 gap-4">
        ...
        <label class="cursor-pointer">
            ...
            <div class="border-2 border-gray-200 rounded-2xl p-5 text-center transition
        ...
        <label class="cursor-pointer">
            ...
            <div class="border-2 border-gray-200 rounded-2xl p-5 text-center transition
                ...
                <img
                    src="https://upload.wikimedia.org/wikipedia/commons/a/ad/Bank_Syariah_Indonesia.svg"
                    class="h-10 mx-auto mb-3"
                >
        ...
        <label class="cursor-pointer">
            ...
            <div class="border-2 border-gray-200 rounded-2xl p-5 text-center transition
                ...
                <img
                    ...
                    class="h-10 mx-auto mb-3 object-contain"
                >
